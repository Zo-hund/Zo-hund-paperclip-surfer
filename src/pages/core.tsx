...
export function MissionsPage() {
  ...
  return <div className="page section-wrap"><PageHeader eyebrow="MISSION RUNWAY" title="Choose your next run" description={`Showing missions configured for ${role} mode.`} actions={<Link to="/role" className="button secondary"><Users/>Change role</Link>}/>
    <section className="mission-world-launch pathfinder-training-launch"><div><span className="eyebrow">LIVE TRAINING / KNOW · DO · BE</span><h2>XRT Pathfinder Educator Training</h2><p>Build an AI-assisted lesson, supervise a Quest experience, design an integrated activity, teach it back, and earn verified educator readiness.</p></div><div className="mission-world-launch-rewards"><span><Clock3/><b>180</b><small>MINUTES</small></span><span><BadgeCheck/><b>7</b><small>CHECKS</small></span><span><Users/><b>3</b><small>LEARNERS</small></span></div><Link className="button primary" to="/missions/pathfinder-educator"><Play/>Start Training</Link></section>
    ...
    <section className="mission-world-launch"><div><span className="eyebrow">LIVE / MULTIPLAYER WEBXR</span><h2>Enter the AMX XR Venue</h2><p>Meet members in the live theater, use Quest controllers, join voice and video, and follow the operator-controlled show.</p></div><div className="mission-world-launch-rewards"><span><Radio/><b>LIVE</b><small>STAGE</small></span><span><Users/><b>48</b><small>MEMBERS</small></span><span><Compass/><b>AR</b><small>VR + MR</small></span></div><Link className="button primary" to="/venues/theater?room=AMXSTAGE"><Play/>Enter Venue</Link></section>

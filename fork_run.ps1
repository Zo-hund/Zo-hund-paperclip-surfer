...
Write-Host "Forking from ses_293e4e111ffeSU33Hzxa1nMaNP to $forkSess..."

$outFile = "C:\Users\Techa\.paperclip\tmp_surfers\fork_$ts.txt"

$psi = New-Object System.Diagnostics.ProcessStartInfo
$psi.FileName = 'powershell.exe'
$psi.Arguments = "-NoProfile -ExecutionPolicy Bypass -Command `"& opencode run --format json --session 'ses_293e4e111ffeSU33Hzxa1nMaNP' --fork --model opencode/big-pickle -- 'You are agent e115eeab-2657-468e-8160-6a9f741f8136 (V3 Audit Lead). Continue your Paperclip work.' 2>&1 | Out-File -FilePath '$outFile' -Encoding UTF8; exit 0`""

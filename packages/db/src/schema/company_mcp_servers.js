...
export const companyMcpServers = pgTable("company_mcp_servers", {
    ...
    transportType: text("transport_type").notNull().$type(),
...
export const agentMcpExclusions = pgTable("agent_mcp_exclusions", {
...
//# sourceMappingURL=company_mcp_servers.js.map
...
export declare const createCostEventSchema: z.ZodEffects<z.ZodObject<{
    ...
    provider: string;
    agentId: string;
    billingType: "fixed" | "unknown" | "metered_api" | "subscription_included" | "subscription_overage" | "credits";
    model: string;
    inputTokens: number;
    ...
    issueId?: string | null | undefined;
    biller?: string | undefined;
    billingType?: "fixed" | "unknown" | "metered_api" | "subscription_included" | "subscription_overage" | "credits" | undefined;

import { z } from "zod";
import { AGENT_ADAPTER_TYPES, INVITE_JOIN_TYPES, JOIN_REQUEST_STATUSES, JOIN_REQUEST_TYPES, OPERATING_ENVIRONMENTS, PERMISSION_KEYS, } from "../constants.js";
export const createCompanyInviteSchema = z.object({
    ...
    inviteeEmail: z.preprocess((value) => typeof value === "string" ? value.trim() : value, z.union([z.string().max(320).email(), z.literal("")]).optional().nullable()),
});

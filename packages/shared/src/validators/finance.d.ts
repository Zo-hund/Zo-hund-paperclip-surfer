...
export declare const createFinanceEventSchema: z.ZodEffects<z.ZodObject<{
    ...
    executionAdapterType: z.ZodNullable<z.ZodOptional<z.ZodEnum<["process", "http", "claude_local", "codex_local", "opencode_local", "pi_local", "cursor", "openclaw_gateway", "hermes_local", "hermes_advanced"]>>>;
    ...
    executionAdapterType?: "process" | "http" | "claude_local" | "codex_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "hermes_local" | "hermes_advanced" | null | undefined;

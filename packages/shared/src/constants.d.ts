...
export declare const OPERATING_ENVIRONMENTS: readonly ["simulation", "live"];
...
export declare const AGENT_ADAPTER_TYPES: readonly ["process", "http", "claude_local", "codex_local", "opencode_local", "pi_local", "cursor", "openclaw_gateway", "hermes_local", "hermes_advanced"];
export type AgentAdapterType = (typeof AGENT_ADAPTER_TYPES)[number];
export declare const AGENT_ROLES: readonly ["ceo", "cto", "cmo", "cfo", "engineer", "designer", "pm", "qa", "devops", "researcher", "auditor", "general"];
...
export declare const APPROVAL_TYPES: readonly ["hire_agent", "approve_ceo_strategy", "budget_override_required", "sim_to_live_promotion"];
...
export declare const HEARTBEAT_RUN_MODES: readonly ["sim", "live"];
export type HeartbeatRunMode = (typeof HEARTBEAT_RUN_MODES)[number];
export declare const LIVE_EVENT_TYPES: readonly ["heartbeat.run.queued", "heartbeat.run.status", "heartbeat.run.event", "heartbeat.run.log", "agent.status", "activity.logged", "plugin.ui.updated", "plugin.worker.crashed", "plugin.worker.restarted", "meeting.started", "meeting.transcript.added", "meeting.participant.joined", "meeting.outcome.added", "meeting.ended", "agent.chat.message"];

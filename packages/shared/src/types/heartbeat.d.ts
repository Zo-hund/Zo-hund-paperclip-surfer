import type { AgentRole, HeartbeatRunMode, OperatingEnvironment, AgentStatus, HeartbeatInvocationSource, HeartbeatRunStatus, WakeupTriggerDetail, WakeupRequestStatus } from "../constants.js";
import type { IssueRuntimeContextTier, IssueRuntimeDeploymentTarget, IssueRuntimeRequirements, IssueRuntimeReasoningTier, IssueRuntimeWorkspaceMode } from "./issue.js";
export type RunFailoverCategory = "rate_limited" | "quota_exhausted" | "provider_denied" | "auth_failed" | "non_retryable";

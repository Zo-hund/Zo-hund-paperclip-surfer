...
Write-Host "RunID: run_$ts"

$msg = "You are agent e115eeab-2657-468e-8160-6a9f741f8136 (V3 Audit Lead). Continue your Paperclip work."

$psi = New-Object System.Diagnostics.ProcessStartInfo
$psi.FileName = 'powershell.exe'
$psi.Arguments = "-NoProfile -ExecutionPolicy Bypass -Command `"& opencode run --format json --model opencode/big-pickle -- '$msg'`""
...
Write-Host "--- STDOUT (first 50 lines) ---"
$stdout -split "`n" | Select-Object -First 50 | ForEach-Object { Write-Host $_ }
